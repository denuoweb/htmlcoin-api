...
AddressController.prototype.transformUtxo = function(utxoArg) {
  var utxo = {
    ...
    tx_hash: utxoArg.txid,
    vout: utxoArg.outputIndex,
    txout_scriptPubKey: utxoArg.script,
    amount: utxoArg.satoshis / 1e8,
    isStake: utxoArg.isStake,
    pubkey_hash: utxoArg.txHash
  };
  if (utxoArg.block_height && utxoArg.block_height > 0) {
    utxo.height = utxoArg.block_height;
    utxo.confirmations = this.node.services.htmlcoind.height - utxoArg.block_height + 1;
  } else {
